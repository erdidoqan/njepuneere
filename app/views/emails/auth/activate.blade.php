            ...
            <tbody><tr>
              ...
              <td style="padding: 0;vertical-align: top">
                <table class="one-col-feature" style="border-collapse: collapse;border-spacing: 0;background-color: #ffffff;font-size: 14px;Margin-left: auto;Margin-right: auto">
                  <tbody><tr>
                    <td class="column" style="padding: 0;vertical-align: top;width: 600px">
                        ...
                        <table class="contents" style="border-collapse: collapse;border-spacing: 0;width: 100%">
                          <tbody><tr>
                            <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px">
                             <h3> Hello, {{ ucwords($username) }}</h3>
            <p style="Margin-top: 0;color: #565656;line-height: 32px;Margin-bottom: 32px;">
            	We are create your njepuneere account,<br> <a href="{{$link}}">Active your account</a>.
            </p>
            ...
            <table style="border-collapse: collapse;border-spacing: 0">
              <tbody><tr>
                <td class="social-link" style="padding: 0;vertical-align: top">
                  <table style="border-collapse: collapse;border-spacing: 0">
                    <tbody>
                    	 <a href="http://facebook.com/njepuneere">
                    <tr>
                      <td style="padding: 0;vertical-align: top">
                ...
                <td class="social-link" style="padding: 0;vertical-align: top">
                  <table style="border-collapse: collapse;border-spacing: 0">
                    <tbody><tr>
                      <td style="padding: 0;vertical-align: top">
                        <forwardtoafriend style="text-decoration:none;" lang="en">
                          <img style="border: 0;-ms-interpolation-mode: bicubic;display: block" src="https://i8.createsend1.com/static/eb/master/01-mason/images/forward-dark.png" width="26" height="21" />
                        </forwardtoafriend>
                      </td>
                      <td class="social-text" style="padding: 0;vertical-align: middle !important;height: 21px;font-size: 10px;font-weight: bold;text-decoration: none;text-transform: uppercase;color: #999;letter-spacing: 0.05em;font-family: Georgia,serif">
                        <forwardtoafriend style="text-decoration:none;" lang="en">
                    ...
                    <tbody><tr>
                      <td class="padded" style="padding: 0;vertical-align: top;padding-left: 10px;padding-right: 0;font-size: 12px;line-height: 20px;color: #999;font-family: Georgia,serif;text-align: right">
                        <div>
                          <span class="block">
                            <span>
                              <preferences style="font-weight:bold;text-decoration:none;" lang="en">
                               <a href="http://njepuneere.com/aboutus" style="color:#496949;font-weight:bold;text-decoration:none;"> About </a>
                              </preferences>
                              <span class="hide">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
                            </span>
                            <span>
                              <preferences style="font-weight:bold;text-decoration:none;" lang="en">
                                <a href="http://njepuneere.com/privacy" style="color:#496949;font-weight:bold;text-decoration:none;">Privacy</a>
                              </preferences>
                              <span class="hide">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
                            </span>
                            <span>
                              <preferences style="font-weight:bold;text-decoration:none;" lang="en">
                                <a href="http://njepuneere.com/term-of-use" style="color:#496949;font-weight:bold;text-decoration:none;">Term of Use</a>
                              </preferences>
                              <span class="hide">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
                            </span>
                          </span>
                          <span class="block"><unsubscribe style="font-weight:bold;text-decoration:none;"><a href="http://njeboteere.org/web/" style="color:#496949;font-weight:bold;text-decoration:none;">Njeboteere</a></unsubscribe></span>
                        </div>
                      </td>
                    </tr>
                  </tbody></table>
